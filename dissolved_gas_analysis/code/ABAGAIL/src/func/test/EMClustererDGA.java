        ...
        DataSet set = new DataSet(instances);
         try {
			...
			for(int i = 0; i < kVals.length; i++) {
				...
				EMClusterer em = new EMClusterer(kVals[i], TOLERANCE, MAX_ITERATIONS);
				em.estimate(set);
            ...
            System.err.println("Problem writing to the file dgaEM.csv");
        }
    }
